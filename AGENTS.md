...
* **Modern Messaging Reference Design:** All visual presentation layers, media behaviors, input drafts, and ephemeral notifications must model the production architectural patterns of modern industry standards (e.g., Telegram, Slack, Signal, Discord, WhatsApp) to guarantee robust, standard user flows.
