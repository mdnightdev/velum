    ...
    <div id="wallet_dashboard" className="flex-1 bg-transparent p-6 lg:p-8 pb-24 lg:pb-8 space-y-6 select-none font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-velum-800 to-velum-950 border border-white-5 rounded-2xl p-6 shadow-xl flex flex-col justify-between h-[180px] group">
          ...
          <div className="bg-velum-800 border border-white-5 rounded-2xl p-5 space-y-4 shadow-md">
          ...
          <div className="bg-velum-800 border border-white-5 rounded-2xl p-5 space-y-3.5 shadow-md">
            <h3 className="text-[10px] uppercase tracking-wider font-bold text-accent font-mono flex items-center gap-1.5">
        ...
        <form onSubmit={handleExchange} className="lg:col-span-5 bg-velum-800 border border-white-5 rounded-2xl p-5 space-y-4 shadow-xl">
          <h3 className="text-[10px] uppercase tracking-wider font-bold text-accent font-mono flex items-center gap-1.5">
