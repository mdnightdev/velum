...
export default function NotificationsMainDashboard({
  ...
  return (
    <div id="notifications_dashboard" className="flex-1 overflow-y-auto bg-velum-900 p-6 lg:p-8 space-y-6 select-none">
      <div>
        <h1 className="text-xs font-semibold uppercase tracking-widest text-text-primary">
          System Notifications
        </h1>
        <p className="text-[10px] text-text-secondary font-mono mt-0.5">
          VELUM NODE TRANSACTION MESSAGES
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Verification Invites */}
        <div className="lg:col-span-6 bg-velum-800 border border-white-5 p-5 rounded-xl space-y-4">
