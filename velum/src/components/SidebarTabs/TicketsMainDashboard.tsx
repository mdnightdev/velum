...
export default function TicketsMainDashboard({
  ...
  return (
    <div id="tickets_dashboard" className="flex-1 overflow-y-auto bg-velum-900 p-6 lg:p-8 space-y-6 select-none">
      <div>
        <h1 className="text-xs font-semibold uppercase tracking-widest text-text-primary">
          Support & Arbitration Portal
        </h1>
        <p className="text-[10px] text-text-secondary font-mono mt-0.5">
          CREDENTIALS VERIFICATION & LOCK DISPUTES
        </p>
      </div>
