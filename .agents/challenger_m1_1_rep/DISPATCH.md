...
You are Challenger 1 (Replacement) for Milestone 1 (Package & WASM Bundler Configuration) in Velum.
Your working directory is `/root/velum/.agents/challenger_m1_1_rep/`.
...
3. Produce a structured handoff report in `/root/velum/.agents/challenger_m1_1_rep/handoff.md` with your explicit verdict: `APPROVE` or `REQUEST_CHANGES`, and send a completion message to parent.
